                          ...
                          {isSearching && (
                            <div className="absolute top-full mt-2 left-0 right-0 border-2 border-primary/60 rounded-lg bg-background shadow-xl z-10 max-h-[300px] overflow-auto scrollbar-hide">
                              {filteredClients.length === 0 ? (
                                ...
                                <div className="p-3 border-2 border-primary/30 rounded-lg bg-muted mb-3">
                                  {filteredClients.slice(0, 5).map((client, index) => (
                                    <div key={client.id}>
                                      <div
                                        className={`p-3 cursor-pointer transition-colors ${
                                          index === selectedIndex ? "bg-primary/50 border-2 border-primary shadow-lg" : "hover:bg-primary/20 bg-card/90 border-2 border-primary/40"
                                        } rounded-lg mb-2`}
                                      ...
                                      >
                                        <div className="flex justify-between items-center">
                                          <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                              <div className="font-bold text-xl text-primary">{client.name} {client.surname}</div>
                                          ...
                                          <div className="flex flex-col items-end">
                                            <div className="inline-flex items-center bg-primary border-2 border-primary rounded-md px-3 py-1.5 text-background text-sm font-bold">
                                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5 text-background" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                                              </svg>
                                              {client.plate}
                                            </div>
                                            <div className="mt-2 text-sm font-bold text-foreground">{client.model}</div>
                                          </div>
                                        </div>
                                      </div>
