        ...
        <div>
          {Object.entries(
            ...
            <div key={category} className="mb-4">
              <div className="bg-muted/60 font-medium p-2 rounded-t-lg">{category}</div>
              <div className="border rounded-b-lg mb-4">
                {categoryItems.map((item, itemIndex) => {
                  ...
                  return (
                    <div 
                      key={item.id}
                      className={`p-3 cursor-pointer transition-all border-b last:border-b-0 ${
                        currentServiceIndex === index ? 'bg-primary/5' : 'hover:bg-muted/40'
                      }`}
                      ...
                      <div className="flex justify-between items-center">
                        <div className="font-medium flex items-center">
                          {currentServiceIndex === index && (
                            <span className="material-icons text-primary mr-1 text-sm">check</span>
                          )}
